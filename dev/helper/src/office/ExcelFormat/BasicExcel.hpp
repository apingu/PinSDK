...
struct CODE
{
    enum {    FORMULA=0x0006,         //Token array and the result of a formula cell.
            ...
            SXFORMULA=0x0103,        //PivotTable Formula record_t
        };
};
...
public:
    ...
    struct Window1 : public record_t
    {
        Window1();
        virtual ULONG Read(const char* data);
        virtual ULONG Write(char* data);
    ...
    struct Palette;
    struct UseSelfs;
    struct BoundSheet : public record_t
    {
        BoundSheet();
        virtual ULONG Read(const char* data);
        virtual ULONG Write(char* data);
    ...
    struct Country;
    struct LinkTable;
    struct SharedStringTable : public record_t
    {
        SharedStringTable();
        virtual ULONG Read(const char* data);
        virtual ULONG Write(char* data);
...
public:
    ...
    struct DefColWidth;
    struct ColInfo : public record_t
    {
        ColInfo();
        virtual ULONG Read(const char* data);
        virtual ULONG Write(char* data);
    ...
    struct Sort;
    struct ColInfos : public record_t
    {
        virtual ULONG Read(const char* data);
        virtual ULONG Write(char* data);
        virtual ULONG RecordSize();
    ...
    struct Dimensions : public record_t
    {
        Dimensions();
        virtual ULONG Read(const char* data);
        virtual ULONG Write(char* data);
    ...
    struct CellTable
    {
        struct RowBlock
        {
            ...
            struct CellBlock : public RefCnt
            {
                ...
                struct BoolErr : public record_t
                {
                    BoolErr();
                    virtual ULONG Read(const char* data);
                    virtual ULONG Write(char* data);
                ...
                struct LabelSST : public record_t
                {
                    LabelSST();
                    virtual ULONG Read(const char* data);
                    virtual ULONG Write(char* data);
                ...
                struct MulBlank : public record_t
                {
                    MulBlank();
                    virtual ULONG Read(const char* data);
                    virtual ULONG Write(char* data);
                ...
                struct Formula : public record_t
                {
                    struct Array : public record_t
                    {
                        Array();
                        virtual ULONG Read(const char* data);
                        virtual ULONG Write(char* data);
                    ...
                    struct ShrFmla : public record_t
                    {
                        ShrFmla();
                        virtual ULONG Read(const char* data);
                        virtual ULONG Write(char* data);
                    ...
                    struct ShrFmla1 : public record_t
                    {
                        ShrFmla1();
                        virtual ULONG Read(const char* data);
                        virtual ULONG Write(char* data);
    ...
    struct Window2 : public record_t
    {
        Window2();
        virtual ULONG Read(const char* data);
        virtual ULONG Write(char* data);
