...
// PROMISE: Return true if file is successfully opened, false if otherwise.
{
    ...
    size_t filenameLength = wcslen(filename);
    file_name_.resize(filenameLength+1, 0);
    wcstombs(&*(file_name_.begin()), filename, filenameLength);

#if _MSC_VER>=1400    // VS 2005
    file_.open(&*(file_name_.begin()), mode | ios_base::binary, _SH_DENYRW);
#else
    file_.open(&*(file_name_.begin()), mode | ios_base::binary);
#endif
...
//        file_.close();
//        file_.open(&*(file_name_.begin()), ios_base::out | ios_base::trunc | ios_base::binary);
        file_.write(buffer, fileSize_); // Write the new file.

        // flush the file immediatelly
        file_.flush();
//        file_.close();
//        file_.open(&*(file_name_.begin()), mode_ | ios_base::binary);
...
/************************************************************************************************************/
record_t::record_t() : dataSize_(0), recordSize_(4) {}
record_t::~record_t() {}

ULONG record_t::Read(const char* data)
{
...
ULONG record_t::Write(char* data)
{
...
ULONG record_t::DataSize() {return dataSize_;}
ULONG record_t::RecordSize() {return recordSize_;}

/************************************************************************************************************/

/************************************************************************************************************/
BOF::BOF() : record_t() {code_ = CODE::BOF; dataSize_ = 16; recordSize_ = 20;}
...
ULONG BOF::Write(char* data)
{
    ...
    return record_t::Write(data);
}
/************************************************************************************************************/

/************************************************************************************************************/
YEOF::YEOF() : record_t() {code_ = CODE::YEOF; dataSize_ = 0; recordSize_ = 4;}
/************************************************************************************************************/
...
/************************************************************************************************************/
Workbook::Window1::Window1() : record_t(),
...
/************************************************************************************************************/
//MF
Workbook::Format::Format() : record_t(),
    index_(0)
{
    code_ = CODE::FORMAT;
    dataSize_ = 2;
...
{
    record_t::Read(data); // XF record in BIFF8 format
...
/************************************************************************************************************/
Workbook::BoundSheet::BoundSheet() : record_t(),
...
/************************************************************************************************************/
Workbook::SharedStringTable::SharedStringTable() : record_t(),
...
/************************************************************************************************************/
Workbook::ExtSST::ExtSST() : record_t(),
...
/************************************************************************************************************/
Worksheet::Index::Index() : record_t(),
...
/************************************************************************************************************/
Worksheet::ColInfo::ColInfo() : record_t(),
...
/************************************************************************************************************/
Worksheet::Dimensions::Dimensions() : record_t(),
...
/************************************************************************************************************/
Worksheet::CellTable::RowBlock::CellBlock::Blank::Blank() : record_t(),
...
Worksheet::CellTable::RowBlock::CellBlock::BoolErr::BoolErr() : record_t(),
...
Worksheet::CellTable::RowBlock::CellBlock::LabelSST::LabelSST() : record_t(),
...
Worksheet::CellTable::RowBlock::CellBlock::MulBlank::MulBlank() : record_t(),
...
Worksheet::CellTable::RowBlock::CellBlock::MulRK::MulRK() : record_t(),
    rowIndex_(0), firstColIndex_(0), lastColIndex_(0)
{
    code_ = CODE::MULRK;
    dataSize_ = 10; recordSize_ = 14;
...
Worksheet::CellTable::RowBlock::CellBlock::Number::Number() : record_t(),
...
Worksheet::CellTable::RowBlock::CellBlock::RK::RK() : record_t(),
...
Worksheet::CellTable::RowBlock::CellBlock::Formula::Formula() : record_t(),
...
Worksheet::CellTable::RowBlock::CellBlock::Formula::Array::Array() : record_t(),
...
Worksheet::CellTable::RowBlock::CellBlock::Formula::ShrFmla::ShrFmla() : record_t(),
...
Worksheet::CellTable::RowBlock::CellBlock::Formula::ShrFmla1::ShrFmla1() : record_t(),
    firstRowIndex_(0), lastRowIndex_(0), firstColIndex_(0), lastColIndex_(0),
    unused_(0)
{
...
Worksheet::CellTable::RowBlock::CellBlock::Formula::Table::Table() : record_t(),
...
/************************************************************************************************************/
Worksheet::CellTable::RowBlock::Row::Row() : record_t(),
...
/************************************************************************************************************/
Worksheet::CellTable::RowBlock::DBCell::DBCell() : record_t(),
    firstRowOffset_(0)
{
    code_ = CODE::DBCELL;
...
/************************************************************************************************************/
Worksheet::Window2::Window2() : record_t(),
...
BasicExcelWorksheet* BasicExcel::AddWorksheet(int sheetIndex)
{
    ...
    do {
        char sheet_name[50];
        sprintf(sheet_name, "Sheet%d", sheetNo++);
        yesheet = AddWorksheet(sheet_name, sheetIndex);
    } while(!yesheet);
