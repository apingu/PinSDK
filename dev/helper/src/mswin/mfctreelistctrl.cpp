...
HTREEITEM CTreeListCtrl::InsertItem(LPCTSTR lpszItem, BOOL bIsEditable, BOOL bHasCombo, HTREEITEM hParent, HTREEITEM hInsertAfter)
{	
...
HTREEITEM CTreeListCtrl::InsertItem( LPCTSTR lpszItem, int nImage, int nSelectedImage, BOOL bIsEditable, BOOL bHasCombo, HTREEITEM hParent, HTREEITEM hInsertAfter)
{
	CTLItem *pItem = new CTLItem;
	pItem->InsertItem(lpszItem);
	pItem->SetEditable(bIsEditable);
