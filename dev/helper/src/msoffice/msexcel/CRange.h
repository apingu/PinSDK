...
public:
    ...
    VARIANT AutoFilter(VARIANT& field_t, VARIANT& Criteria1, long XlFile, VARIANT& Criteria2, VARIANT& VisibleDropDown)
    {
        VARIANT result;
        static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_I4 VTS_VARIANT VTS_VARIANT ;
        InvokeHelper(0x319, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, &field_t, &Criteria1, XlFile, &Criteria2, &VisibleDropDown);
        return result;
    }
    VARIANT AutoFit()
    {
