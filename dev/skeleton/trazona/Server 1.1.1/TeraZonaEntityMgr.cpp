...
// desc :
//=============================================================================
ZonaServerEntity* CEntity::getEntity( void )
{
     return getEntityWithId( eID );
}
...
// desc :
//=============================================================================
void CEntity::setRId( int rid )
{
	getEntity()->setRegionId( rid );
	return;
}
...
// desc :
//=============================================================================
int CEntity::getRId( void )
{
	return getEntity()->getRegionId();
}
...
// desc :
//=============================================================================
void CEntityMgr::AddEntity( ZonaServerEntity *zonaentity )
{
	CEntity* entity = new CEntity;
	entity->eID = zonaentity->getId();
