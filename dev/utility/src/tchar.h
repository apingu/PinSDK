...
#define _wcsninc(_pc, _sz) (((_pc)+(_sz)))
    _Check_return_ _ACRTIMP size_t __cdecl __wcsncnt( _In_reads_or_z_( _Maxcount_ ) const wchar_t * _Str, _In_ size_t _Maxcount_ );
...
#define _wcsncpy_l(_Destination, _Source, _count_, _Locale)                              (wcsncpy(_Destination, _Source, _count_))
#if __STDC_WANT_SECURE_LIB__
#define _wcsncpy_s_l(_Destination, _Destination_size_chars, _Source, _count_, _Locale)   (wcsncpy_s(_Destination, _Destination_size_chars, _Source, _count_))
#endif  /* __STDC_WANT_SECURE_LIB__ */
#define _wcsncat_l(_Destination, _Source, _count_, _Locale)                              (wcsncat(_Destination, _Source, _count_))
#if __STDC_WANT_SECURE_LIB__
#define _wcsncat_s_l(_Destination, _Destination_size_chars, _Source, _count_, _Locale)   (wcsncat_s(_Destination, _Destination_size_chars, _Source, _count_))
#endif  /* __STDC_WANT_SECURE_LIB__ */
...
#define _wcsnset_l(_Destination, _Value, _count_, _Locale)                               (_wcsnset(_Destination, _Value, _count_))
#define _wcsnset_s_l(_Destination, _Destination_size_chars, _Value, _count_, _Locale)    (_wcsnset_s(_Destination, _Destination_size_chars, _Value, _count_))
...
#if __STDC_WANT_SECURE_LIB__
    _Check_return_wat_ __inline errno_t __CRTDECL _wcsncpy_s_l( _Out_writes_z_( _Destination_size_chars ) wchar_t *_Destination, _In_ size_t _Destination_size_chars, _In_z_ const wchar_t *_Source, _In_ size_t _count_, _In_opt_ _locale_t _Locale )
    {
        _CRT_UNUSED( _Locale );
        return wcsncpy_s( _Destination, _Destination_size_chars, _Source, _count_ );
    }
#endif  /* __STDC_WANT_SECURE_LIB__ */

    __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3( errno_t, _wcsncpy_s_l, wchar_t, _Dest, _In_z_ const wchar_t *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )

        __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( wchar_t *, __RETURN_POLICY_DST, _wcsncpy_l, _wcsncpy_s_l, _Out_writes_z_( _Size ) wchar_t, _Out_writes_( _count_ ) wchar_t, _Dst, _In_z_ const wchar_t *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )
    {
        _CRT_UNUSED( _Locale );
#pragma warning( push )
#pragma warning( disable : 4996 6054 28719)
        return wcsncpy( _Dst, _Source, _count_ );
#pragma warning( pop )
    }

    __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( wchar_t *, __RETURN_POLICY_DST, _wcsncpy_l, _wcsncpy_s_l, _Out_writes_z_( _Size ) wchar_t, _Out_writes_( _count_ ), wchar_t, _Dst, _In_z_ const wchar_t *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )

#if __STDC_WANT_SECURE_LIB__
        _Check_return_wat_ __inline errno_t __CRTDECL _wcsncat_s_l( _Inout_updates_z_( _Destination_size_chars ) wchar_t *_Destination, _In_ size_t _Destination_size_chars, _In_z_ const wchar_t *_Source, _In_ size_t _count_, _In_opt_ _locale_t _Locale )
    {
        _CRT_UNUSED( _Locale );
        return wcsncat_s( _Destination, _Destination_size_chars, _Source, _count_ );
    }
#endif  /* __STDC_WANT_SECURE_LIB__ */

    __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3( errno_t, _wcsncat_s_l, wchar_t, _Dest, _In_z_ const wchar_t *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )

        __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( wchar_t *, __RETURN_POLICY_DST, _wcsncat_l, _wcsncat_s_l, _Inout_updates_z_( _Size ) wchar_t, _Inout_z_ wchar_t, _Dst, _In_z_ const wchar_t *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )
    {
        _CRT_UNUSED( _Locale );
#pragma warning( push )
#pragma warning( disable : 4996 6054 6059 28719 )
        /* prefast noise VSW 489802 */
        return wcsncat( _Dst, _Source, _count_ );
#pragma warning( pop )
    }

    __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( wchar_t *, __RETURN_POLICY_DST, _wcsncat_l, _wcsncat_s_l, _Inout_updates_z_( _Size ) wchar_t, _Inout_z_, wchar_t, _Dst, _In_z_ const wchar_t *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )
...
#pragma warning(pop)
    ...
    _Check_return_wat_ __inline errno_t _wcsnset_s_l( _Inout_updates_z_( _Destination_size_chars ) wchar_t * _Destination, _In_ size_t _Destination_size_chars, _In_ wchar_t _Value, _In_ size_t _count_, _In_opt_ _locale_t _Locale )
    {
        _CRT_UNUSED( _Locale );
        return _wcsnset_s( _Destination, _Destination_size_chars, _Value, _count_ );
    }

    __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3( errno_t, _wcsnset_s_l, _Prepost_z_ wchar_t, _Dest, _In_ wchar_t, _Value, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )

        __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( wchar_t *, __RETURN_POLICY_DST, _wcsnset_l, _wcsnset_s_l, _Inout_updates_z_( _Size ) wchar_t, _Inout_updates_z_( _Maxcount_ ) wchar_t, _Dst, _In_ wchar_t, _Value, _In_ size_t, _Maxcount_, _In_opt_ _locale_t, _Locale )
    {
        _CRT_UNUSED( _Locale );
#pragma warning( push )
#pragma warning( disable : 4996 )
        return _wcsnset( _Dst, _Value, _Maxcount_ );
#pragma warning( pop )
    }

    __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( wchar_t *, __RETURN_POLICY_DST, _wcsnset_l, _wcsnset_s_l, _Inout_updates_z_( _Size ) wchar_t, _Inout_updates_z_( _Maxcount_ ), wchar_t, _Dst, _In_ wchar_t, _Value, _In_ size_t, _Maxcount_, _In_opt_ _locale_t, _Locale )
...
#define _tccpy_s_l  _mbccpy_s_l
    ...
    _CRT_INSECURE_DEPRECATE( _tcsncat_s ) _ACRTIMP char * __cdecl _tcsncat( _Inout_updates_z_( _Maxcount_ ) char *_Dst, _In_z_ const char *_Src, _In_ size_t _Maxcount_ );
    _ACRTIMP char * __cdecl _tcsncat_s( _Inout_updates_z_( _DstSizeInChars ) char *_Dst, _In_ size_t _DstSizeInChars, _In_z_ const char *_Src, size_t _Maxcount_ );
    _CRT_INSECURE_DEPRECATE( _tcsncat_s_l ) _ACRTIMP char * __cdecl _tcsncat_l( _Inout_updates_z_( _Maxcount_ ) char *_Dst, _In_z_ const char *_Src, _In_ size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    _ACRTIMP char * __cdecl _tcsncat_s_l( _Inout_updates_z_( _DstSizeInChars ) char *_Dst, _In_ size_t _DstSizeInChars, _In_z_ const char *_Src, _In_ size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    _CRT_INSECURE_DEPRECATE( _tcsncpy_s ) _ACRTIMP char * __cdecl _tcsncpy( _Out_writes_( _Maxcount_ ) _Post_maybez_ char *_Dst, _In_z_ const char *_Src, size_t _Maxcount_ );
    _ACRTIMP char * __cdecl _tcsncpy_s( _Out_writes_( _DstSizeInChars ) char *_Dst, _In_ size_t _DstSizeInChars, _In_z_ const char *_Src, size_t _Maxcount_ );
    _CRT_INSECURE_DEPRECATE( _tcsncpy_s_l ) _ACRTIMP char * __cdecl _tcsncpy_l( _Out_writes_( _Maxcount_ ) _Post_maybez_ char *_Dst, _In_z_ const char *_Src, _In_ size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    _ACRTIMP char * __cdecl _tcsncpy_s_l( _Out_writes_( _DstSizeInChars ) char *_Dst, _In_ size_t _DstSizeInChars, _In_z_ const char *_Src, _In_ size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    ...
    _CRT_INSECURE_DEPRECATE( _tcsnset_s ) _ACRTIMP char * __cdecl _tcsnset( _Inout_z_ char * _Str, _In_ unsigned int _Val, _In_ size_t _Maxcount_ );
    _Check_return_wat_ _ACRTIMP errno_t __cdecl _tcsnset_s( _Inout_updates_z_( _SizeInChars ) char * _Str, _In_ size_t _SizeInChars, _In_ unsigned int _Val, _In_ size_t _Maxcount_ );
    _CRT_INSECURE_DEPRECATE( _tcsnset_s_l ) _ACRTIMP char * __cdecl _tcsnset_l( _Inout_z_ char * _Str, _In_ unsigned int _Val, _In_ size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    _Check_return_wat_ _ACRTIMP errno_t __cdecl _tcsnset_s_l( _Inout_updates_z_( _SizeInChars ) char * _Str, _In_ size_t _SizeInChars, _In_ unsigned int _Val, _In_ size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    ...
    _Check_return_ _ACRTIMP int __cdecl _tcsnccmp( _In_z_ const char * _Str1, _In_z_ const char * _Str2, _In_ size_t _Maxcount_ );
    _Check_return_ _ACRTIMP int __cdecl _tcsncmp( _In_z_ const char * _Str1, _In_z_ const char * _Str2, _In_ size_t _Maxcount_ );
    _Check_return_ _ACRTIMP int __cdecl _tcsncicmp( _In_z_ const char * _Str1, _In_z_ const char * _Str2, _In_ size_t _Maxcount_ );
    _Check_return_ _ACRTIMP int __cdecl _tcsncicmp_l( _In_z_ const char *_Str1, _In_z_ const char *_Str2, _In_ size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    _Check_return_ _ACRTIMP int __cdecl _tcsnicmp( _In_z_ const char * _Str1, _In_z_ const char * _Str2, _In_ size_t _Maxcount_ );
    _Check_return_ _ACRTIMP int __cdecl _tcsnicmp_l( _In_z_ const char *_Str1, _In_z_ const char *_Str2, size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    ...
    _Check_return_ _ACRTIMP int __cdecl _tcsnccoll( _In_z_ const char * _Str1, _In_z_ const char * _Str2, _In_ size_t _Maxcount_ );
    _Check_return_ _ACRTIMP int __cdecl _tcsnccoll_l( _In_z_ const char *_Str1, _In_z_ const char *_Str2, _In_ size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    _Check_return_ _ACRTIMP int __cdecl _tcsncoll( _In_z_ const char *_Str1, _In_z_ const char * _Str2, _In_ size_t _Maxcount_ );
    _Check_return_ _ACRTIMP int __cdecl _tcsncoll_l( _In_z_ const char *_Str1, _In_z_ const char *_Str2, size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    _Check_return_ _ACRTIMP int __cdecl _tcsncicoll( _In_z_ const char * _Str1, _In_z_ const char * _Str2, _In_ size_t _Maxcount_ );
    _Check_return_ _ACRTIMP int __cdecl _tcsncicoll_l( _In_z_ const char *_Str1, _In_z_ const char *_Str2, _In_ size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    _Check_return_ _ACRTIMP int __cdecl _tcsnicoll( _In_z_ const char * _Str1, _In_z_ const char * _Str2, _In_ size_t _Maxcount_ );
    _Check_return_ _ACRTIMP int __cdecl _tcsnicoll_l( _In_z_ const char *_Str1, _In_z_ const char *_Str2, _In_ size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    ...
    _Post_satisfies_( return <= _String_length_( _Str ) && return <= _Maxcount_ )
        _Check_return_ _ACRTIMP size_t __cdecl _tcscnlen( _In_z_ const char *_Str, _In_ size_t _Maxcount_ );

    _Post_satisfies_( return <= _String_length_( _Str ) )
        _Check_return_ _ACRTIMP size_t __cdecl _tcsclen_l( _In_z_ const char *_Str, _In_opt_ _locale_t _Locale );

    _Post_satisfies_( return <= _String_length_( _Str ) && return <= _Maxcount_ )
        _Check_return_ _ACRTIMP size_t __cdecl _tcscnlen_l( _In_z_ const char *_Str, _In_ size_t _Maxcount_, _In_opt_ _locale_t _Locale );

    _CRT_INSECURE_DEPRECATE( _tcsnccat_s ) _ACRTIMP char * __cdecl _tcsnccat( _Inout_ char *_Dst, _In_z_ const char *_Src, _In_ size_t _Maxcount_ );
    _ACRTIMP char * __cdecl _tcsnccat_s( _Inout_updates_z_( _DstSizeInChars ) char *_Dst, _In_ size_t _DstSizeInChars, _In_z_ const char *_Src, _In_ size_t _Maxcount_ );
    _CRT_INSECURE_DEPRECATE( _tcsnccat_s_l ) _ACRTIMP char * __cdecl _tcsnccat_l( _Inout_ char *_Dst, _In_z_ const char *_Src, _In_ size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    _ACRTIMP char * __cdecl _tcsnccat_s_l( _Inout_updates_z_( _DstSizeInChars ) char *_Dst, _In_ size_t _DstSizeInChars, _In_z_ const char *_Src, _In_ size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    _CRT_INSECURE_DEPRECATE( _tcsnccpy_s ) _ACRTIMP char * __cdecl _tcsnccpy( _Out_writes_( _Maxcount_ ) _Post_maybez_ char *_Dst, _In_z_ const char *_Src, _In_ size_t _Maxcount_ );
    _ACRTIMP char * __cdecl _tcsnccpy_s( _Out_writes_( _DstSizeInChars ) char *_Dst, _In_ size_t _DstSizeInChars, _In_z_ const char *_Src, _In_ size_t _Maxcount_ );
    _CRT_INSECURE_DEPRECATE( _tcsnccpy_s_l ) _ACRTIMP char * __cdecl _tcsnccpy_l( _Out_writes_( _Maxcount_ ) _Post_maybez_ char *_Dst, _In_z_ const char *_Src, _In_ size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    _ACRTIMP char * __cdecl _tcsnccpy_s_l( _Out_writes_( _DstSizeInChars ) char *_Dst, _In_ size_t _DstSizeInChars, _In_z_ const char *_Src, _In_ size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    _CRT_INSECURE_DEPRECATE( _tcsncset_s ) _ACRTIMP char * __cdecl _tcsncset( _Inout_updates_z_( _Maxcount_ ) char * _Str, _In_ unsigned int _Val, _In_ size_t _Maxcount_ );
    _ACRTIMP char * __cdecl _tcsncset_s( _Inout_updates_z_( _SizeInChars ) char * _Str, _In_ size_t _SizeInChars, _In_ unsigned int _Val, _In_ size_t _Maxcount_ );
    _CRT_INSECURE_DEPRECATE( _tcsncset_s_l ) _ACRTIMP char * __cdecl _tcsncset_l( _Inout_updates_z_( _Maxcount_ ) char * _Str, _In_ unsigned int _Val, _In_ size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    _ACRTIMP char * __cdecl _tcsncset_s_l( _Inout_updates_z_( _SizeInChars ) char * _Str, _In_ size_t _SizeInChars, _In_ unsigned int _Val, _In_ size_t _Maxcount_, _In_opt_ _locale_t _Locale );
    ...
    _ACRTIMP size_t __cdecl _tcsnbcnt( _In_reads_or_z_( _Maxcount_ ) const char * _Str, _In_ size_t _Maxcount_ );
    _ACRTIMP size_t __cdecl _tcsnccnt( _In_reads_or_z_( _Maxcount_ ) const char * _Str, _In_ size_t _Maxcount_ );
    _ACRTIMP unsigned int __cdecl _tcsnextc( _In_z_ const char * _Str );
    _ACRTIMP char * __cdecl _tcsninc( _In_reads_or_z_( _count_ ) const char * _Ptr, _In_ size_t _count_ );
...
/* String functions */
    ...
    _Check_return_wat_ __inline errno_t _tcsncat_s( _Inout_updates_z_( _Destination_size_chars ) char *_Destination, _In_ size_t _Destination_size_chars, _In_z_ const char *_Source, _In_ size_t _count_ )
    {
        return _mbsnbcat_s( ( unsigned char * )_Destination, _Destination_size_chars, ( const unsigned char * )_Source, _count_ );
    }

    __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2( errno_t, _tcsncat_s, _Prepost_z_ char, _Dest, _In_z_ const char *, _Source, _In_ size_t, _count_ )

        __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_2_EX( char *, __RETURN_POLICY_DST, _tcsncat, _tcsncat_s, _Inout_updates_z_( _Size ) char, _Inout_z_ char, _Dst, _In_z_ const char *, _Source, _In_ size_t, _count_ )
    {
#pragma warning(push)
#pragma warning(disable:4996)
#pragma warning(disable:28726) // Banned API
        return ( char * )_mbsnbcat( ( unsigned char * )_Dst, ( const unsigned char * )_Source, _count_ );
#pragma warning(pop)
    }

    __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_2_EX( char *, __RETURN_POLICY_DST, _tcsncat, _tcsncat_s, _Inout_updates_z_( _Size ) char, _Inout_z_, char, _Dst, _In_z_ const char *, _Source, _In_ size_t, _count_ )

        _Check_return_wat_ __inline errno_t _tcsncat_s_l( _Inout_updates_z_( _Destination_size_chars ) char *_Destination, _In_ size_t _Destination_size_chars, _In_z_ const char *_Source, _In_ size_t _count_, _In_opt_ _locale_t _Locale )
    {
        return _mbsnbcat_s_l( ( unsigned char * )_Destination, _Destination_size_chars, ( const unsigned char * )_Source, _count_, _Locale );
    }

    __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3( errno_t, _tcsncat_s_l, _Prepost_z_ char, _Dest, _In_z_ const char *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )

        __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( char *, __RETURN_POLICY_DST, _tcsncat_l, _tcsncat_s_l, _Inout_updates_z_( _Size ) char, _Inout_z_ char, _Dst, _In_z_ const char *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )
    {
#pragma warning(push)
#pragma warning(disable:4996)
        return ( char * )_mbsnbcat_l( ( unsigned char * )_Dst, ( const unsigned char * )_Source, _count_, _Locale );
#pragma warning(pop)
    }

    __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( char *, __RETURN_POLICY_DST, _tcsncat_l, _tcsncat_s_l, _Inout_updates_z_( _Size ) char, _Inout_z_, char, _Dst, _In_z_ const char *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )

        _Check_return_wat_ __inline errno_t _tcsncpy_s( _Out_writes_z_( _Destination_size_chars ) char * _Destination, _In_ size_t _Destination_size_chars, _In_z_ const char * _Source, _In_ size_t _count_ )
    {
        return _mbsnbcpy_s( ( unsigned char * )_Destination, _Destination_size_chars, ( const unsigned char * )_Source, _count_ );
    }

    __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2( errno_t, _tcsncpy_s, _Post_z_ char, _Dest, _In_z_ const char *, _Source, _In_ size_t, _count_ )

        __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_2_EX( _Success_( return != 0 ) char *, __RETURN_POLICY_DST, _tcsncpy, _tcsncpy_s, _Out_writes_bytes_( _count_ ) _Post_maybez_ char, _Out_writes_bytes_( _count_ ) _Post_maybez_ char, _Dst, _In_z_ const char *, _Source, _In_ size_t, _count_ )
    {
#pragma warning(push)
#pragma warning(disable:4996)
#pragma warning(disable:28726) // Banned API
        return ( char * )_mbsnbcpy( ( unsigned char * )_Dst, ( const unsigned char * )_Source, _count_ );
#pragma warning(pop)
    }

    __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_2_EX( char *, __RETURN_POLICY_DST, _tcsncpy, _tcsncpy_s, _Out_writes_z_( _Size ) char, _Inout_z_, char, _Dst, _In_z_ const char *, _Source, _In_ size_t, _count_ )

        _Check_return_wat_ __inline errno_t _tcsncpy_s_l( _Out_writes_z_( _Destination_size_chars ) char * _Destination, _In_ size_t _Destination_size_chars, _In_z_ const char * _Source, _In_ size_t _count_, _In_opt_ _locale_t _Locale )
    {
        return _mbsnbcpy_s_l( ( unsigned char * )_Destination, _Destination_size_chars, ( const unsigned char * )_Source, _count_, _Locale );
    }

    __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3( errno_t, _tcsncpy_s_l, _Post_z_ char, _Dest, _In_z_ const char *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )

        __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( char *, __RETURN_POLICY_DST, _tcsncpy_l, _tcsncpy_s_l, _Out_writes_z_( _Size ) char, _Out_writes_bytes_( _count_ ) _Post_maybez_ char, _Dst, _In_z_ const char *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )
    {
#pragma warning(push)
#pragma warning(disable:4996)
        return ( char * )_mbsnbcpy_l( ( unsigned char * )_Dst, ( const unsigned char * )_Source, _count_, _Locale );
#pragma warning(pop)
    }

    __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( char *, __RETURN_POLICY_DST, _tcsncpy_l, _tcsncpy_s_l, _Out_writes_z_( _Size ) char, _Out_writes_z_( _count_ ), char, _Dst, _In_z_ const char *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )
...
#pragma warning(pop)
    ...
    _Check_return_wat_ __inline errno_t _tcsnset_s( _Inout_updates_z_( _SizeInBytes ) char * _Dst, _In_ size_t _SizeInBytes, _In_ unsigned int _Value, _In_ size_t _count_ )
    {
        return _mbsnbset_s( ( unsigned char * )_Dst, _SizeInBytes, _Value, _count_ );
    }

    __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2( errno_t, _tcsnset_s, _Prepost_z_ char, _Dest, _In_ unsigned int, _Value, _In_ size_t, _count_ )

        __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_2_EX( char *, __RETURN_POLICY_DST, _tcsnset, _tcsnset_s, _Inout_updates_z_( _Size ) char, _Inout_updates_z_( _count_ ) char, _Dst, _In_ unsigned int, _Value, _In_ size_t, _count_ )
    {
#pragma warning(push)
#pragma warning(disable:4996)
        return ( char * )_mbsnbset( ( unsigned char * )_Dst, _Value, _count_ );
#pragma warning(pop)
    }

    __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_2_EX( char *, __RETURN_POLICY_DST, _tcsnset, _tcsnset_s, _Inout_updates_z_( _Size ) char, _Inout_updates_z_( _count_ ), char, _Dst, _In_ unsigned int, _Value, _In_ size_t, _count_ )

        _Check_return_wat_ __inline errno_t _tcsnset_s_l( _Inout_updates_z_( _SizeInBytes ) char * _Dst, _In_ size_t _SizeInBytes, _In_ unsigned int _Value, _In_ size_t _count_, _In_opt_ _locale_t _Locale )
    {
        return _mbsnbset_s_l( ( unsigned char * )_Dst, _SizeInBytes, _Value, _count_, _Locale );
    }

    __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3( errno_t, _tcsnset_s_l, _Prepost_z_ char, _Dest, _In_ unsigned int, _Value, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )

        __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( char *, __RETURN_POLICY_DST, _tcsnset_l, _tcsnset_s_l, _Inout_updates_z_( _Size ) char, _Inout_updates_z_( _count_ ) char, _Dst, _In_ unsigned int, _Value, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )
    {
#pragma warning(push)
#pragma warning(disable:4996)
        return ( char * )_mbsnbset_l( ( unsigned char * )_Dst, _Value, _count_, _Locale );
#pragma warning(pop)
    }

    __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( char *, __RETURN_POLICY_DST, _tcsnset_l, _tcsnset_s_l, _Inout_updates_z_( _Size ) char, _Inout_updates_z_( _count_ ), char, _Dst, _In_ unsigned int, _Value, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )
...
#pragma warning(pop)
    ...
    _Check_return_ __inline int _tcsnccoll( _In_z_ const char * _String1, _In_z_ const char * _String2, _In_ size_t _count_ )
    {
        return _mbsncoll( ( const unsigned char * )_String1, ( const unsigned char * )_String2, _count_ );
    }

    _Check_return_ __inline int _tcsnccoll_l( _In_z_ const char * _String1, _In_z_ const char * _String2, _In_ size_t _count_, _In_opt_ _locale_t _Locale )
    {
        return _mbsncoll_l( ( const unsigned char * )_String1, ( const unsigned char * )_String2, _count_, _Locale );
    }

    _Check_return_ __inline int _tcsncoll( _In_z_ const char * _String1, _In_z_ const char * _String2, _In_ size_t _count_ )
    {
        return _mbsnbcoll( ( const unsigned char * )_String1, ( const unsigned char * )_String2, _count_ );
    }

    _Check_return_ __inline int _tcsncoll_l( _In_z_ const char * _String1, _In_z_ const char * _String2, _In_ size_t _count_, _In_opt_ _locale_t _Locale )
    {
        return _mbsnbcoll_l( ( const unsigned char * )_String1, ( const unsigned char * )_String2, _count_, _Locale );
    }

    _Check_return_ __inline int _tcsncicoll( _In_z_ const char * _String1, _In_z_ const char * _String2, _In_ size_t _count_ )
    {
        return _mbsnicoll( ( const unsigned char * )_String1, ( const unsigned char * )_String2, _count_ );
    }

    _Check_return_ __inline int _tcsncicoll_l( _In_z_ const char * _String1, _In_z_ const char * _String2, _In_ size_t _count_, _In_opt_ _locale_t _Locale )
    {
        return _mbsnicoll_l( ( const unsigned char * )_String1, ( const unsigned char * )_String2, _count_, _Locale );
    }

    _Check_return_ __inline int _tcsnicoll( _In_z_ const char * _String1, _In_z_ const char * _String2, _In_ size_t _count_ )
    {
        return _mbsnbicoll( ( const unsigned char * )_String1, ( const unsigned char * )_String2, _count_ );
    }

    _Check_return_ __inline int _tcsnicoll_l( _In_z_ const char * _String1, _In_z_ const char * _String2, _In_ size_t _count_, _In_opt_ _locale_t _Locale )
    {
        return _mbsnbicoll_l( ( const unsigned char * )_String1, ( const unsigned char * )_String2, _count_, _Locale );
    }
    ...
    _Check_return_wat_ __inline errno_t _tcsnccat_s( _Inout_updates_z_( _Destination_size_chars ) char * _Destination, _In_ size_t _Destination_size_chars, _In_z_ const char * _Source, _In_ size_t _count_ )
    {
        return _mbsncat_s( ( unsigned char * )_Destination, _Destination_size_chars, ( const unsigned char * )_Source, _count_ );
    }

    __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2( errno_t, _tcsnccat_s, _Prepost_z_ char, _Dest, _In_z_ const char *, _Source, _In_ size_t, _count_ )

        __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_2_EX( char *, __RETURN_POLICY_DST, _tcsnccat, _tcsnccat_s, _Inout_updates_z_( _Size ) char, _Inout_z_ char, _Dst, _In_z_ const char *, _Source, _In_ size_t, _count_ )
    {
#pragma warning(push)
#pragma warning(disable:4996)
#pragma warning(disable:28726) // Banned API
        return ( char * )_mbsncat( ( unsigned char * )_Dst, ( const unsigned char * )_Source, _count_ );
#pragma warning(pop)
    }

    __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_2_EX( char *, __RETURN_POLICY_DST, _tcsnccat, _tcsnccat_s, _Inout_updates_z_( _Size ) char, _Inout_z_, char, _Dst, _In_z_ const char *, _Source, _In_ size_t, _count_ )

        _Check_return_wat_ __inline errno_t _tcsnccat_s_l( _Inout_updates_z_( _Destination_size_chars ) char * _Destination, _In_ size_t _Destination_size_chars, _In_z_ const char * _Source, _In_ size_t _count_, _In_opt_ _locale_t _Locale )
    {
        return _mbsncat_s_l( ( unsigned char * )_Destination, _Destination_size_chars, ( const unsigned char * )_Source, _count_, _Locale );
    }

    __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3( errno_t, _tcsnccat_s_l, _Prepost_z_ char, _Dest, _In_z_ const char *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )

        __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( char *, __RETURN_POLICY_DST, _tcsnccat_l, _tcsnccat_s_l, _Inout_updates_z_( _Size ) char, _Inout_z_ char, _Dst, _In_z_ const char *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )
    {
#pragma warning(push)
#pragma warning(disable:4996)
        return ( char * )_mbsncat_l( ( unsigned char * )_Dst, ( const unsigned char * )_Source, _count_, _Locale );
#pragma warning(pop)
    }

    __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( char *, __RETURN_POLICY_DST, _tcsnccat_l, _tcsnccat_s_l, _Inout_updates_z_( _Size ) char, _Inout_z_, char, _Dst, _In_z_ const char *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )

        _Check_return_wat_ __inline errno_t _tcsnccpy_s( _Out_writes_z_( _Destination_size_chars ) char * _Destination, _In_ size_t _Destination_size_chars, _In_z_ const char * _Source, _In_ size_t _count_ )
    {
        return _mbsncpy_s( ( unsigned char * )_Destination, _Destination_size_chars, ( const unsigned char * )_Source, _count_ );
    }

    __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2( errno_t, _tcsnccpy_s, _Post_z_ char, _Dest, _In_z_ const char *, _Source, _In_ size_t, _count_ )

        __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_2_EX( char *, __RETURN_POLICY_DST, _tcsnccpy, _tcsnccpy_s, _Out_writes_bytes_( _Size ) _Post_maybez_ char, _Pre_notnull_ _Post_maybez_ char, _Dst, _In_z_ const char *, _Source, _In_ size_t, _count_ )
    {
#pragma warning(push)
#pragma warning(disable:4996)
#pragma warning(disable:28726) // Banned API
        return ( char * )_mbsncpy( ( unsigned char * )_Dst, ( const unsigned char * )_Source, _count_ );
#pragma warning(pop)
    }

    __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_2_EX( char *, __RETURN_POLICY_DST, _tcsnccpy, _tcsnccpy_s, _Out_writes_z_( _Size ) char, _Pre_notnull_ _Post_z_, char, _Dst, _In_z_ const char *, _Source, _In_ size_t, _count_ )

        _Check_return_wat_ __inline errno_t _tcsnccpy_s_l( _Out_writes_z_( _Destination_size_chars ) char * _Destination, _In_ size_t _Destination_size_chars, _In_z_ const char * _Source, _In_ size_t _count_, _In_opt_ _locale_t _Locale )
    {
        return _mbsncpy_s_l( ( unsigned char * )_Destination, _Destination_size_chars, ( const unsigned char * )_Source, _count_, _Locale );
    }

    __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3( errno_t, _tcsnccpy_s_l, _Post_z_ char, _Dest, _In_z_ const char *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )

        __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( char *, __RETURN_POLICY_DST, _tcsnccpy_l, _tcsnccpy_s_l, _Out_writes_z_( _Size ) char, _Out_writes_bytes_( _count_ ) _Post_maybez_ char, _Dst, _In_z_ const char *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )
    {
#pragma warning(push)
#pragma warning(disable:4996)
        return ( char * )_mbsncpy_l( ( unsigned char * )_Dst, ( const unsigned char * )_Source, _count_, _Locale );
#pragma warning(pop)
    }

    __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( char *, __RETURN_POLICY_DST, _tcsnccpy_l, _tcsnccpy_s_l, _Out_writes_z_( _Size ) char, _Out_writes_bytes_( _count_ ) _Post_maybez_, char, _Dst, _In_z_ const char *, _Source, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )

        _Check_return_wat_ __inline errno_t _tcsncset_s( _Inout_updates_bytes_( _SizeInBytes ) char *_Destination, _In_ size_t _SizeInBytes, _In_ unsigned int _Value, _In_ size_t _count_ )
    {
        return _mbsnset_s( ( unsigned char * )_Destination, _SizeInBytes, _Value, _count_ );
    }

    __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2( errno_t, _tcsncset_s, char, _Dest, _In_ unsigned int, _Value, _In_ size_t, _count_ )

        __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_2_EX( char *, __RETURN_POLICY_DST, _tcsncset, _tcsncset_s, _Inout_updates_z_( _Size ) char, _Inout_updates_bytes_( _count_ ) char, _Dst, _In_ unsigned int, _Value, _In_ size_t, _count_ )
    {
#pragma warning(push)
#pragma warning(disable:4996)
        return ( char * )_mbsnset( ( unsigned char * )_Dst, _Value, _count_ );
#pragma warning(pop)
    }

    __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_2_EX( char *, __RETURN_POLICY_DST, _tcsncset, _tcsncset_s, _Inout_updates_z_( _Size ) char, _Inout_updates_bytes_( _count_ ), char, _Dst, _In_ unsigned int, _Value, _In_ size_t, _count_ )

        _Check_return_wat_ __inline errno_t _tcsncset_s_l( _Inout_updates_bytes_( _SizeInBytes ) char *_Destination, _In_ size_t _SizeInBytes, _In_ unsigned int _Value, _In_ size_t _count_, _In_opt_ _locale_t _Locale )
    {
        return _mbsnset_s_l( ( unsigned char * )_Destination, _SizeInBytes, _Value, _count_, _Locale );
    }

    __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3( errno_t, _tcsncset_s_l, char, _Dest, _In_ unsigned int, _Value, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )

        __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( char *, __RETURN_POLICY_DST, _tcsncset_l, _tcsncset_s_l, _Inout_updates_z_( _Size ) char, _Inout_updates_bytes_( _count_ ) char, _Dst, _In_ unsigned int, _Value, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )
    {
#pragma warning(push)
#pragma warning(disable:4996)
        return ( char * )_mbsnset_l( ( unsigned char * )_Dst, _Value, _count_, _Locale );
#pragma warning(pop)
    }

    __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX( char *, __RETURN_POLICY_DST, _tcsncset_l, _tcsncset_s_l, _Inout_updates_z_( _Size ) char, _Inout_updates_bytes_( _count_ ), char, _Dst, _In_ unsigned int, _Value, _In_ size_t, _count_, _In_opt_ _locale_t, _Locale )
...
#pragma warning(pop)
    ...
    __DEFINE_CPP_OVERLOAD_INLINE_FUNC_0_1_EX( char *, __RETURN_POLICY_DST, _tcslwr_l, _tcslwr_s_l, _Inout_updates_z_( _Size ) char, _Inout_z_ char, _String, _In_opt_ _locale_t, _Locale )
        ...
        _Check_return_wat_ __inline errno_t _tcsupr_s( _Inout_updates_z_( _count_ ) char * _String, _In_ size_t _count_ )
    {
        return _mbsupr_s( ( unsigned char * )_String, _count_ );
    }
...
#pragma warning(pop)
    ...
    __DEFINE_CPP_OVERLOAD_INLINE_FUNC_0_0_EX( char *, __RETURN_POLICY_DST, _tcsupr, _tcsupr_s, _Inout_updates_z_( _Size ) char, _Inout_z_ char, _String )
        ...
        _Check_return_wat_ __inline errno_t _tcsupr_s_l( _Inout_updates_z_( _count_ ) char * _String, _In_ size_t _count_, _In_opt_ _locale_t _Locale )
    {
        return _mbsupr_s_l( ( unsigned char * )_String, _count_, _Locale );
    }
