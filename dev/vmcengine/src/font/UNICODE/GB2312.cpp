...
//added by OB, for lacks!?
0x2221, 0x2170, // SMALL ROMAN NUMERAL ONE
0x2222, 0x2171,	// SMALL ROMAN NUMERAL TWO
0x2223, 0x2172,	// SMALL ROMAN NUMERAL THREE
0x2224, 0x2173,	// SMALL ROMAN NUMERAL FOUR
0x2225, 0x2174,	// SMALL ROMAN NUMERAL FIVE
0x2226, 0x2175,	// SMALL ROMAN NUMERAL SIX
0x2227, 0x2176,	// SMALL ROMAN NUMERAL SEVEN
0x2228, 0x2177,	// SMALL ROMAN NUMERAL EIGHT
0x2229, 0x2178,	// SMALL ROMAN NUMERAL NINE
0x222A, 0x2179,	// SMALL ROMAN NUMERAL TEN
//end
...
//Added by OB, for it lacks
0x283B, 0x0251,	// LATIN SMALL LETTER ALPHA
//0x233C, ????,	// LATIN SMALL LETTER M WITH ACUTE
0x283D, 0x0144,	// LATIN SMALL LETTER N WITH ACUTE
0x283E, 0x0148, // LATIN SMALL LETTER N WITH CARON
//0x283F, ????, // LATIN SMALL LETTER N WITH GRAVE
0x2840, 0x261,	// LATIN SMALL LETTER SCRIPT G
//end
...
static int CharSets = sizeof(GB2Unicode) / (sizeof(ULONG) * 2);


ULONG GB2312_to_Unicode(ULONG gb)
{
	gb -= 0x8080;

	// Use binary search dumbass!
	// ...

	// Huhhunn..Use the CPU power wussy!
	for (int i = 0; i < CharSets * 2; i += 2)
	{
		if (GB2Unicode[i] == gb)
			return GB2Unicode[i + 1];
	}
...
// NOTE: reverse searching is suck!
ULONG Unicode_to_GB2312(ULONG unicode)
{
	for (int i = 1; i < CharSets * 2; i += 2)
	{
		if (GB2Unicode[i] == unicode)
			return GB2Unicode[i - 1] + 0x8080;
	}
