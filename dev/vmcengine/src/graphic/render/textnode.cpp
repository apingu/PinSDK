...
extern bool Ansi2Unicode(UINT codepage,const tchar_t* ansistr,wchar_t* output);
#endif
#include "VMCText.h"
...
// 
// static PIXELFMT  s_ColorFmt=(PIXELFMT)0;
// 
// // ====================================================================
// 
...
UINT cText_Node::s_CodePage = CP_ACP;	// system default
