...
typedef bool (*CellIdCallBack)(cellid_t id, GSO::StreamCellDescriptor desc, uint_t order, void* pDefData);
...
namespace GSO
{
	...
	public:
		uint_t        ForAllCell(CellIdCallBack callback, void* pData);
...
//		const char*     GetCellName    (int Id);
		...
		void                    ForAllNeighborhood(cellid_t Id, CellIdCallBack func, void* data);
		//void                    ForAllNeighborhood(cellid_t Id, ZoneCallBack func, void* data);
