...
HWND CreateMyWindow( LPSTR strWindowName,
                     int width,
                     int height,
                     DWORD dwStyle,
                     bool bFullScreen,
                     HINSTANCE hInstance )
{
    ...
    // Create the window
    hWnd = CreateWindow( "GameTutorials",
                         strWindowName,
                         dwStyle,
                         0,
                         0,
                    ...
                    int ishow )
{
    ...
    if( MessageBox( NULL,
                    "Click Yes to go to full screen (Recommended)",
                    "Options",
    ...
    hWnd = CreateMyWindow( "www.GameTutorials.com - Texture Mapping JPEGs",
                           SCREEN_WIDTH,
                           SCREEN_HEIGHT,
                           0,
                           g_bFullScreen,
