...
//  Desc :
//=============================================================================
 Pvoid  VFW3D::SetRenderFunc( int ( __cdecl *RenderFunc )( Pvoid ) )
{
...
//=============================================================================
Pint VFW3D::Initialize3D( void* displayID )
{
#if defined (_WGLKERNEL_) || defined (_XGLKERNEL_)
    ...
    {
        DebugMessage( "Initialise: Failed to attach world plugin", "VFWRW" );
        return FALSE;
    }
    ...
    {
        DebugMessage( "Initialise: Failed to attach random plugin", "VFWRW" );
        return FALSE;
    }

    if( !RpMatFXPluginAttach() )
    {
        DebugMessage( "Initialise: Failed to attach matfx plugin", "VFWRW" );
        return FALSE;
    }
...
Pvoid VFW3D::Destroy( Pvoid )
{
    ...
    if( m_hDC != NULL )
    {
        ...
        {
            DebugMessage( "Release Device Context Failed", "V3D" );
        }else
...
//  Desc :
//=============================================================================
Pbool VFW3D::SetPixelFormat( Pint bbp )
{
    m_depth = bbp;
    ...
    if( !( m_hDC = GetDC( ( HWND ) m_DisplayID ) ) )               // Did We Get A Device Context?
    {
...
//=============================================================================
Pbool VFW3D::SetRenderContext( Pvoid )
{
#ifdef _WGLKERNEL_
    if( m_hDC == 0 )
        return FALSE;
...
//  Desc :
//=============================================================================
Pbool VFW3D::Open( void* displayID, Pint bbp )
{
    //displayID = m_MyWnd;
    if( displayID == 0 )
    {
...
//  Desc :
//=============================================================================
Pint VFW3D::Show( const VfCamera* camera )
{
#ifdef _WGLKERNEL_
    glFlush();
    SwapBuffers( m_hDC );
...
//=============================================================================
/*
 Pvoid  VFW3D::Turn_On_Light( Pword num )
{
...
//  Desc :
//=============================================================================
 Pvoid  VFW3D::Turn_Off_Light( Pword num )
{
    if( num <= _VMC_MAX_LIGHT ) // turn on one light
    {
        Light[num].Disable();
...
//  Desc :
//=============================================================================
VfMetrics* VFW3D::GetMetrics( VfMetrics* ginfo )
{
#ifdef _RWKERNEL_
    RwMetrics* metrics;
...
//=============================================================================
Pvoid VFW3D::Create_Font( const char* font_type, int s_w, int s_h )
{
...
//=============================================================================
Pvoid VFW3D::Text( int x, int y, COLORTYPE col, Pcstr string )
{
#if defined( _GLKERNEL_ ) && defined ( _WIN32 )
...
//=============================================================================
Pvoid VFW3D::Destroy_Font( Pvoid )
{
#if defined( _GLKERNEL_ ) && defined ( _WIN32 )
